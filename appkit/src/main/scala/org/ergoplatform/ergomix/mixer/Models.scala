...
object Models {
  ...
  case class OutBox(id:String, amount:Long, registers:Map[String, String], ergoTree:String, tokens:Seq[Token], creationHeight:Int, address:String, spendingTxId:Option[String]){
